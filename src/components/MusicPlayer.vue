      ...
      <div class="music-player-container">
        ...
        <div class="player-body">
          ...
          <div class="control-panel">
            <button class="control-btn" @click.stop="prevSong" :disabled="!songList.length">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19 20L9 12L19 4V20Z" fill="#693e9c"/>
                <path d="M5 19V5L15 12L5 19Z" fill="#693e9c"/>
              </svg>
            </button>
            <button class="play-btn" @click.stop="initAudioAndPlay" :class="{ playing: isPlaying }" :disabled="!songList.length">
              <span v-if="!isPlaying">播放</span>
              <span v-else>暂停</span>
            </button>
            <button class="control-btn" @click.stop="nextSong" :disabled="!songList.length">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 4L15 12L5 20V4Z" fill="#693e9c"/>
                <path d="M19 5V19L9 12L19 5Z" fill="#693e9c"/>
              </svg>
            </button>
          </div>
          ...
          <div class="song-list-wrapper">
            <div class="list-header">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 18H21V16H3V18ZM3 13H21V11H3V13ZM3 6V8H21V6H3Z" fill="#693e9c"/>
              </svg>
              <span>歌曲列表</span>
            </div>
            <div class="song-list-container">
              <div class="song-list">
                ...
                >
                  ...
                  <span class="song-active-icon" v-if="currentSongIndex === index && isPlaying">
  ...
  .player-cover-wrapper {
    ...
    .player-cover {
      ...
      .cover-bg {
        ...
        height: 100%;
        border-radius: 50%;
        background: radial-gradient(circle at 30% 30%, #af7dc4 0%, transparent 60%);
        opacity: 0.2;
      }
